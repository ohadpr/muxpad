...
Work happens on the `xterm-hardening` branch in the worktree at `/Users/ohadpr/Dropbox/Computer/MyDev/2025/webagents-xterm-hardening`. The default working directory for every command below is that path.
...
```bash
grep -n "OP_" /Users/ohadpr/Dropbox/Computer/MyDev/2025/webagents-xterm-hardening/shared/src/ws-protocol.ts
```
...
```bash
grep -n "decodeClientMessage" /Users/ohadpr/Dropbox/Computer/MyDev/2025/webagents-xterm-hardening/server/src/ws.ts
```
...
```bash
cat /Users/ohadpr/Dropbox/Computer/MyDev/2025/webagents-xterm-hardening/server/src/ws.test.ts
```
