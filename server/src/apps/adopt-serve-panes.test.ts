...
const NOTES_CMD =
  'muxpad serve --url https://dt-mac-mini.west-hydra.ts.net:4322 --label Notes -- ./start';
const READER_CMD =
  'muxpad serve --url https://dt-mac-mini.west-hydra.ts.net:4748 --label Reader -- ./start';

describe('parseServeCommand', () => {
  it('parses the live Notes command exactly', () => {
    expect(parseServeCommand(NOTES_CMD)).toEqual({
      url: 'https://dt-mac-mini.west-hydra.ts.net:4322',
      label: 'Notes',
      command: './start',
    });
  });
